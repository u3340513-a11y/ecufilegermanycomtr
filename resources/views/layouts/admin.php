...
<head>
    ...
    <title><?= \Core\View::escape($pageTitle ?? 'Yönetim') ?> — <?php
        $titleRow = \Core\Database::getInstance()->fetch("SELECT value FROM settings WHERE key_name = 'admin_panel_title'");
        echo \Core\View::escape(!empty($titleRow['value']) ? $titleRow['value'] : 'ECU Admin');
    ?></title>
