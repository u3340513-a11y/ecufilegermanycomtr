...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 700; background: linear-gradient(135deg, #3b82f6, #06b6d4); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; margin-bottom: 1rem; }
...
<body>
    <div class="error-page">
        ...
        <p class="error-desc">Aradığınız sayfa mevcut değil veya kaldırılmış olabilir.</p>
