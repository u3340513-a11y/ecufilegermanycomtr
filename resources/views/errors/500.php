...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 700; background: linear-gradient(135deg, #ef4444, #dc2626); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; margin-bottom: 1rem; }
...
<body>
    <div class="error-page">
        ...
        <p class="error-desc">Bir hata oluştu. Lütfen daha sonra tekrar deneyin.</p>
